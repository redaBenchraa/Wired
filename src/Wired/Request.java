...
public class Request {
    ...
    public Request(int id, String cT, String a1, String a2, String cN, boolean s, boolean v, boolean e, Date sD, Date eD, Date vD, String rT, String rN, int idB, int idT, String problem) {
